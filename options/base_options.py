...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--netG', type=str, default='unet_128',
                            help='selects model to use for netG. Look on Networks3D to see the all list')

        parser.add_argument('--gpu_ids', default='7', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        parser.add_argument('--name', type=str, default='experiment_name',
                            help='name of the experiment. It decides where to store samples and models')
        parser.add_argument('--model', type=str, default='share_gan',
                            help='chooses which model to use. share_gan,joint_gan')
        ...
        parser.add_argument('--use_earlystop', action='store_true', help='use earlystop')
        parser.add_argument('--usejoint', action='store_true',
                            help='joint learning')
